...
In this project I created a function that takes a string as an argument and determines the frequency of each word in it. It does not include any single-character words. The result is an object with each word being the property name and the frequency count being the value.

#### How to Run:
1. Clone or fork this Repo
2. Open the files in Atom and either trigger the live server by pressing `ctrl + shift + 3` or open the `index.html` file in your web browser.
3. The output will be in the console, so open your inspector to view it.
